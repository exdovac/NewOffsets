...
inline constexpr uintptr_t DataModelToRenderView1 = 0x700;
inline constexpr uintptr_t DataModelToRenderView2 = 0x1C0;
...
inline constexpr uintptr_t TextLabelText = 0xE48;
